...
class SentenceEncoder(nn.Module):   # inherihing nn.modulee to sentense enccoder class
    """
    ...
    # Define layer in layers using __init__
    def __init__(
        self,
        vocab_size: int,
        embeddings: torch.Tensor,
        ...
        # print("Sentense encoder  init 5")

        # dropout
        self.dropout = nn.Dropout(dropout) 
        # print("Sentense encoder  init 6")

        self.tanh = nn.Tanh()
        # print("Sentense encoder  init 7")

        self.softmax = nn.Softmax(dim=1)
        # print("Sentense encoder  init 8")
    ...
    def forward(
        ...
        # print("sentences_per_document.tolist()")
        # print(sentences_per_document.tolist())
        # print("Sentense encoder  forwarder 1")  #open  document and convert to word
        ...
        # print("Sentense encoder  forwarder 2")
        # print(packed_sentences)
        # re-arrange sentence lengths in the same way (DOCUMENTS -> SENTENCES)   #open  sentence  and convert to word
        ...
        # print("Sentense encoder  forwarder 3")
        # print(packed_words_per_sentence)
        ...
        # print("Sentense encoder  forwarder 4")
        # print(sentences)
        # print(word_alphas)
        sentences = self.dropout(sentences)
        # print("Sentense encoder  forwarder 5")
        # print(sentences)
        # print("word enccoder callled return to sentense again ")
        # run through sentence-level RNN (PyTorch automatically applies it on the PackedSequence) # closed s word
        ...
        # print("Sentense encoder  forwarder 6")
        # print(packed_sentences)
        ...
        # print("Sentense encoder  forwarder 7")
        # print(documents)
        # print(_)
        ...
        # print("Sentense encoder  forwarder 8")
        # print(u_i)
        ...
        # print("Sentense encoder  forwarder 9")
        # print(sent_alphas)
        # form document vectors
        # eq.10: v = \sum_i a_i h_i
        ...
        # print("Sentense encoder  forwarder 10")
        # print(documents)
        ...
        # print("Sentense encoder  forwarder  11")
        # print('Sentence Encoder return Data')
        # print("documents")
        # print(documents)
        # print("word_alphas")
        # print(word_alphas)
